...
(function() {
  ...
  _p[1] = {
    value: function(require, exports, module) {
       ...
       * 这是天盘图与其余的模板不同的地方
       */
      connect.register("arc_tp", function(
        node,
        parent,
        connection,
        width,
        ...
        if (nextNode && nextNode.getConnection()) {
          ...
          var jl2 = Math.sqrt(
            Math.pow(end.x - next_end.x, 2) + Math.pow(end.y - next_end.y, 2)
          );
          //两圆中心点距离
          pathData = [];
          pathData.push("M", end);
  ...
  _p[6] = {
    value: function(require, exports, module) {
      var kity = _p.r(17);
      var connect = _p.r(11);
      connect.register("under", function(
        node,
        parent,
        connection,
        width,
      ...
      kity.extendClass(Minder, {
        ...
        execCommand: function(name) {
          ...
          if (!this._hasEnterExecCommand) {
            ...
            stoped = this._fire(
              new MinderEvent("beforeExecCommand", eventParams, true)
            );
            if (!stoped) {
    ...
    value: function(require, exports, module) {
      ...
      register("default", function(node, parent, connection) {
        connection.setPathData([
          "M",
          parent.getLayoutVertexOut(),
          "L",
          node.getLayoutVertexIn()
        ]);
      });
      kity.extendClass(MinderNode, {
        ...
        getConnectProvider: function() {
          return (
            _connectProviders[this.getConnect()] || _connectProviders["default"]
          );
        },
        /**
         * @private
      ...
      Module.register("Connect", {
        init: function() {
          this._connectContainer = new kity.Group().setId(
            utils.uuid("minder_connect_group")
          );
    ...
    value: function(require, exports, module) {
      ...
      kity.extendClass(Minder, {
          ...
          if (protocolName) {
            ...
            if (!protocol || !protocol.encode) {
              return Promise.reject(
                new Error("Not supported protocol:" + protocolName)
              );
            }
          }
          // 导出前抛个事件
        ...
        importData: function(protocolName, data, option) {
          ...
          return Promise.resolve(protocol.decode(data, this, option)).then(
            function(json) {
      ...
      kity.extendClass(Minder, {
        ...
        _firePharse: function(e) {
          ...
          if (e.type == "DOMMouseScroll") {
            e.type = "mousewheel";
            e.wheelDelta = e.originEvent.wheelDelta =
              e.originEvent.detail * -10;
        ...
        _listen: function(type, callback) {
          var callbacks =
            this._eventCallbacks[type] || (this._eventCallbacks[type] = []);
      ...
      kity.extendClass(Minder, {
        ...
        applyLayoutResult: function(root, duration, callback) {
          ...
          function apply(node, pMatrix) {
            ...
            var lastMatrix =
              node.getGlobalLayoutTransform() || new kity.Matrix();
            ...
            // 如果要求以动画形式来更新，创建动画
            if (duration) {
              node._layoutTimeline = new kity.Animator(
                lastMatrix,
                matrix,
                applyMatrix
              )
          ...
          apply(
            root,
            root.parent
              ? root.parent.getGlobalLayoutTransform()
              : new kity.Matrix()
          );
          return this;
        }
            ...
            if (dealRenderers) {
              for (type in dealRenderers) {
                ...
                if (utils.isArray(dealRenderers[type])) {
                  this._rendererClasses[type] = this._rendererClasses[
                    type
                  ].concat(dealRenderers[type]);
                } else {
    ...
    value: function(require, exports, module) {
                ...
                if (renderer.shouldRender(node)) {
                  ...
                  if (!renderer.getRenderShape()) {
                    ...
                    if (renderer.bringToBack) {
                      node
                        .getRenderContainer()
                        .prependShape(renderer.getRenderShape());
                    } else {
                      node
                        .getRenderContainer()
                        .appendShape(renderer.getRenderShape());
                    }
                  }
                  // 强制让渲染图形显示
                  renderer.getRenderShape().setVisible(true);
                  // 更新渲染图形
                  lastBoxes[j] = renderer.update(
                    renderer.getRenderShape(),
                    node,
                    node._contentBox
                  );
      ...
      kity.extendClass(MinderNode, {
        ...
        getRenderBox: function(rendererType, refer) {
          ...
          var contentBox = renderer
            ? renderer.contentBox
            : this.getContentBox();
          var ctm = kity.Matrix.getCTM(
          ...
          this.on("keydown", function(e) {
            for (var keys in map) {
              ...
              if (e.isShortcutKey(keys)) {
                var fn = map[keys];
                if (
                  fn.__statusCondition &&
                  fn.__statusCondition != this.getStatus()
                )
                  return;
                fn();
                e.preventDefault();
        ...
        (function() {
          ...
          return {
            ...
            getTheme: function(node) {
              var support =
                this.getTemplateSupport("getTheme") || originGetTheme;
      ...
      kity.extendClass(
        ...
        (function() {
          ...
          return {
            getLayout: function() {
              var support =
                this.getMinder().getTemplateSupport("getLayout") ||
                originGetLayout;
              return support.call(this, this);
            },
            getConnect: function() {
              var support =
                this.getMinder().getTemplateSupport("getConnect") ||
                originGetConnect;
              return support.call(this, this);
            }
          };
  ...
  _p[32] = {
    value: function(require, exports, module) {
      ...
      var cssLikeValueMatcher = {
        left: function(value) {
          return (
            (3 in value && value[3]) || (1 in value && value[1]) || value[0]
          );
        },
          ...
          kity.createClass({
            ...
            doLayout: function(parent, children) {
              ...
              children.forEach(function(child) {
                ...
                if (axis == "x") {
                  child.setVertexIn(
                    new kity.Point(cbox[oppsite[name]], cbox.cy)
                  );
                  child.setLayoutVectorIn(new kity.Vector(dir, 0));
                } else {
                  child.setVertexIn(
                    new kity.Point(cbox.cx, cbox[oppsite[name]])
                  );
              ...
              if (axis == "x") {
                ...
                xAdjust +=
                  dir * children[0].getStyle("margin-" + oppsite[name]);
                yAdjust = pbox.bottom;
      ...
      Layout.register(
        ...
        kity.createClass("FishBoneMasterLayout", {
          ...
          doLayout: function(parent, children, round) {
            ...
            var yAdjustUp =
              pBox.cy - cMarginBottom - parent.getStyle("margin-top");
            var yAdjustDown =
              pBox.cy + cMarginTop + parent.getStyle("margin-bottom");
  ...
  _p[42] = {
    value: function(require, exports, module) {
      ...
      function canArrange(km) {
        ...
        return (
          selected && selected.parent && selected.parent.children.length > 1
        );
      }
      /**
       * @command ArrangeUp
  ...
  _p[45] = {
    value: function(require, exports, module) {
      ...
      var OrderHinter = kity.createClass("OrderHinter", {
        ...
        render: function(hint) {
          ...
          if (hint) {
            ...
            this.area.fill(
              hint.node.getStyle("order-hint-area-color") ||
                "rgba(0, 255, 0, .5)"
            );
      ...
      var TreeDragger = kity.createClass("TreeDragger", {
        ...
        _orderTest: function() {
          this._orderSucceedHint = this._boxTest(this._orderHints, function(
            hint
          ) {
            return hint.area;
          });
  ...
  _p[47] = {
    value: function(require, exports, module) {
      ...
      TextRenderer.registerStyleHook(function(node, textGroup) {
        ...
        var foreColor =
          dataColor ||
          (node.isSelected() && selectedColor ? selectedColor : styleColor);
        ...
        renderers: {
          right: kity.createClass("hyperlinkrender", {
            ...
            create: function() {
              ...
              var outline = new kity.Rect(24, 22, -2, -6, 4).fill(
                "rgba(255, 255, 255, 0)"
              );
    ...
    value: function(require, exports, module) {
      ...
      Module.register("ImageViewer", function() {
        ...
        var ImageViewer = kity.createClass("ImageViewer", {
          constructor: function() {
            var btnClose = createEl(
              "button",
              "km-image-viewer-btn km-image-viewer-close"
            );
            var btnSource = createEl(
              "button",
              "km-image-viewer-btn km-image-viewer-source"
            );
            var image = (this.image = createEl("img"));
            var toolbar = (this.toolbar = createEl(
              "div",
              "km-image-viewer-toolbar",
              [btnSource, btnClose]
            ));
            var container = createEl("div", "km-image-viewer-container", [
              image
            ]);
            var viewer = (this.viewer = createEl("div", "km-image-viewer", [
              toolbar,
              container
            ]));
  ...
  _p[55] = {
    value: function(require, exports, module) {
      ...
      var OutlineRenderer = kity.createClass("OutlineRenderer", {
        ...
        update: function(outline, node, box) {
          ...
          if (shape && shape == "circle") {
            ...
            var r = Math.round;
            radius = r(
              Math.sqrt(p(outlineBox.width, 2) + p(outlineBox.height, 2)) / 2
            );
      ...
      marker.addShape(
        new kity.Path().setPathData("M-5-3l5,3,-5,3").stroke("#33ffff")
      );
          ...
          events: !wireframeOption
            ...
            : {
                ...
                layoutallfinish: function() {
                  this.getRoot().traverse(function(node) {
                    node
                      .getRenderer("WireframeRenderer")
                      .update(null, node, node.getContentBox());
                  });
                }
              },
          renderers: {
  ...
  _p[56] = {
    value: function(require, exports, module) {
      ...
      Module.register("PriorityModule", function() {
        ...
        // jscs:disable maximumLineLength
        var BACK_PATH =
          "M0,13c0,3.866,3.134,7,7,7h6c3.866,0,7-3.134,7-7V7H0V13z";
        var MASK_PATH =
  ...
  _p[58] = {
    value: function(require, exports, module) {
      ...
      Module.register("Resource", function() {
         ...
         * 自动使用的颜色序列
         */
        var RESOURCE_COLOR_SERIES = [51, 303, 75, 200, 157, 0, 26, 254].map(
          function(h) {
        ...
        kity.extendClass(Minder, {
          ...
          _getNextResourceColorIndex: function() {
            ...
            for (resource in colorMapping) {
              if (
                Object.prototype.hasOwnProperty.call(colorMapping, resource)
              ) {
        ...
        var ResourceRenderer = kity.createClass("ResourceRenderer", {
          ...
          update: function(container, node, box) {
            ...
            for (i = 0; i < resource.length; i++) {
              ...
              overlay.setValue(
                resource[i],
                minder.getResourceColor(resource[i])
              );
          ...
          return {
            ...
            selectMove: function(e) {
              ...
              if (!marqueeMode) {
                // 距离没达到阈值，退出
                if (
                  kity.Vector.fromPoints(p1, p2).length() <
        ...
        return {
          commands: {
            ...
            pastestyle: kity.createClass("PastStyleCommand", {
              ...
              queryState: function(minder) {
                return styleClipBoard && minder.getSelectedNodes().length
                  ? 0
                  : -1;
              }
            }),
    ...
    value: function(require, exports, module) {
      ...
      var TextRenderer = kity.createClass("TextRenderer", {
        ...
        update: function(textGroup, node) {
          ...
          var height =
            lineHeight * fontSize * textArr.length -
          ...
          return function() {
            textGroup.eachItem(function(i, textShape) {
              ...
              rBox = rBox.merge(
                new kity.Box(0, y, (bbox.height && bbox.width) || 1, fontSize)
              );
            });
            var nBox = new kity.Box(
              r(rBox.x),
              r(rBox.y),
              r(rBox.width),
              r(rBox.height)
    ...
    value: function(require, exports, module) {
      ...
      Module.register("Zoom", function() {
        ...
        function setTextRendering() {
          var value =
            me._zoomValue >= 100 ? "optimize-speed" : "geometricPrecision";
      ...
      function getSVGInfo(minder) {
        ...
        function traverse(node) {
          ...
          if (nodeData.image) {
            ...
            var imageRenderBox = node.getRenderBox(
              "ImageRenderer",
              minder.getRenderContainer()
            );
            var imageInfo = {
              url: imageUrl,
    ...
    value: function(require, exports, module) {
      ...
      template.register("fish-bone", {
        getLayout: function(node) {
          ...
          return node.getLayoutPointPreview().y > 0
            ? "filetree-up"
            : "filetree-down";
        },
        getConnect: function(node) {
